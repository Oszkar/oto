...
void main() {
  testWidgets('onDismiss null renders with no OtoScaffold and no dismiss chevron',
      (t) async {
    final h = wrap(
  ...
  testWidgets('onDismiss non-null shows the dismiss chevron and invokes the callback',
      (t) async {
    var dismissed = false;
    final h = wrap(
